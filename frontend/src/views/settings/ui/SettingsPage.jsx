  ...
  return (
    <button
      ...
      className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-[#131926] ${
        checked ? "bg-[#131926]" : "bg-slate-200"
      }`}
    >
      <span
...
function ToggleRow({ label, description, checked, onChange, id }) {
  return (
    <label
      htmlFor={id}
      className="flex cursor-pointer items-center justify-between gap-4 rounded-xl px-1 py-3 transition-colors hover:bg-slate-50"
    >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl">
        ...
        <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-2xl ${danger ? "bg-red-100" : "bg-slate-100"}`}>
          <LogOut className={`h-6 w-6 ${danger ? "text-red-600" : "text-slate-600"}`} />
        </div>
...
export function SettingsPage() {
  ...
  // ── Настройки ──
  const [prefs, setPrefs] = useState(/** @type {Prefs} */ (defaultPrefs()));
  ...
  useEffect(() => {
    const saved = storageGet(PREFS_KEY, null);
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-2xl py-8">
        {/* Заголовок */}
        <div className="mb-8">
          <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">Настройки</h1>
          ...
          <Card>
            ...
            <div className="divide-y divide-slate-100">
              ...
              <div className="flex items-center justify-between gap-4 rounded-xl px-1 py-3">
                <div>
                  <p className="text-sm font-medium text-slate-800">Тема оформления</p>
                  <p className="mt-0.5 text-xs text-slate-500">Светлая или тёмная тема</p>
                </div>
          ...
          <Card>
            ...
            <div className="px-1">
              <div className="mb-2 flex items-center justify-between">
                ...
                <span className="rounded-lg bg-slate-100 px-2.5 py-1 text-sm font-bold text-slate-900">
                  {prefs.riskThreshold}%
                </span>
              </div>
              <input
                ...
                className="h-2 w-full cursor-pointer appearance-none rounded-full bg-slate-200 accent-[#131926]"
          ...
          <Card className="border-red-100">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="group flex w-full items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-3.5 text-left transition-colors hover:border-amber-200 hover:bg-amber-50"
              >
                <div className="flex items-center gap-3">
                  <KeyRound className="h-5 w-5 text-slate-400 group-hover:text-amber-600" />
                  <div>
              ...
              <button
                ...
                className="group flex w-full items-center justify-between rounded-xl border border-red-100 bg-red-50 px-4 py-3.5 text-left transition-colors hover:border-red-300 hover:bg-red-100"
              >
                <div className="flex items-center gap-3">
