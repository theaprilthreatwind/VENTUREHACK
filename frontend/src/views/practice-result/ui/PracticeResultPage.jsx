      ...
      <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Попытка #{result.attemptId}</p>
          </div>
        </div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          <div className="rounded-2xl bg-emerald-50 p-4 text-center">
            ...
            <p className="mt-1 text-xs text-emerald-700">
              {formatNumber(correct)} из {formatNumber(total)}
            </p>
          </div>
          <div className="rounded-2xl bg-red-50 p-4 text-center">
            ...
            <p className="mt-1 text-xs text-red-700">
              {formatNumber(incorrect)} из {formatNumber(total)}
            </p>
          </div>
        </div>
        ...
        <div
          role="img"
          aria-label={`Правильные ${correctPercent}%, неправильные ${incorrectPercent}%`}
        ...
        <div className="mt-6 grid grid-cols-3 gap-3 text-center">
          <div className="rounded-xl border border-slate-200 p-3">
            ...
            <p className="text-[11px] text-slate-400">Верно</p>
          </div>
          <div className="rounded-xl border border-slate-200 p-3">
            ...
            <p className="text-[11px] text-slate-400">Неверно</p>
          </div>
          <div className="rounded-xl border border-slate-200 p-3">
            ...
            <p className="text-[11px] text-slate-400">Без ответа</p>
          </div>
        </div>
