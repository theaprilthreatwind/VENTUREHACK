...
function SidebarContent({ pathname, onNavigate }) {
  return (
    <div className="flex h-full flex-col justify-between overflow-y-auto bg-white px-5 py-6">
        ...
        {bottomItems.map((item) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={onNavigate}
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-xs font-medium text-slate-500 transition-colors hover:bg-slate-50 hover:text-slate-800"
            >
