...
export const dictionaries = {
  ru: {
    ...
    analytics: {
      ...
      subtitle: "Ваш прогресс по решённым заданиям и последним сессиям.",
      kpiTests: "Пройдено тестов",
      kpiSolved: "Решено вопросов",
      kpiCorrect: "Верных ответов",
      kpiSuccess: "Общая успешность",
      coverageTitle: "Покрытие банка заданий",
      coverageValue: "{solved} из {total}",
      coverageHint: "Доля решённых заданий от общего числа в базе",
      lastSessionTitle: "Последняя сессия",
      lastSessionAttempt: "Попытка #{id}",
      lastSessionCorrect: "Верно",
      lastSessionIncorrect: "Неверно",
      lastSessionUnanswered: "Без ответа",
      lastSessionTime: "Время:",
      lastSessionEmpty: "Вы ещё не проходили ни одной сессии.",
      startPractice: "Начать практику",
      empty: "Статистика пока пуста — решите несколько заданий.",
      loading: "Загружаем статистику…",
      guest: "Войдите в аккаунт, чтобы видеть статистику.",
      signIn: "Войти",
      retry: "Повторить",
    },
    error: {
    ...
    notFound: {
      ...
      description: "Возможно, страница удалена или адрес указан с ошибкой.",
      home: "На главную",
    },
    settings: {
      title: "Настройки",
    ...
    errors: {
      ...
      requestTimeout: "Превышено время ожидания ответа: {method} {url}",
      ...
      loadStats: "Не удалось загрузить статистику",
    },
  },
  ...
  kk: {
    ...
    analytics: {
      title: "Оқу үлгерімінің аналитикасы",
      subtitle: "Шешілген тапсырмалар мен соңғы сессиялар бойынша прогресіңіз.",
      kpiTests: "Өткен тесттер",
      kpiSolved: "Шешілген сұрақтар",
      kpiCorrect: "Дұрыс жауаптар",
      kpiSuccess: "Жалпы табыстылық",
      coverageTitle: "Тапсырмалар базасының қамтылуы",
      coverageValue: "{total} ішінен {solved}",
      coverageHint: "Базадағы жалпы саннан шешілген тапсырмалардың үлесі",
      lastSessionTitle: "Соңғы сессия",
      lastSessionAttempt: "№{id} әрекет",
      lastSessionCorrect: "Дұрыс",
      lastSessionIncorrect: "Қате",
      lastSessionUnanswered: "Жауапсыз",
      lastSessionTime: "Уақыт:",
      lastSessionEmpty: "Сіз әлі бірде-бір сессия өтпегенсіз.",
      startPractice: "Жаттығуды бастау",
      empty: "Статистика әзірге бос — бірнеше тапсырма шешіңіз.",
      loading: "Статистика жүктелуде…",
      guest: "Статистиканы көру үшін аккаунтқа кіріңіз.",
      signIn: "Кіру",
      retry: "Қайталау",
    },
    error: {
      title: "Бірдеңе дұрыс болмады",
      description: "Күтпеген қате орын алды. Қайталап көріңіз.",
      retry: "Қайта көру",
    },
    notFound: {
      title: "Бет табылмады",
      description: "Бет жойылған немесе мекенжай қате көрсетілген болуы мүмкін.",
      home: "Басты бетке",
    },
    settings: {
      title: "Баптаулар",
    ...
    errors: {
      ...
      requestTimeout: "Жауап күту уақыты асып кетті: {method} {url}",
      ...
      loadStats: "Статистиканы жүктеу мүмкін болмады",
    },
  },
};
