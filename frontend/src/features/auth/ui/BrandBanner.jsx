    ...
    <div className="relative hidden overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-blue-700 p-12 text-white lg:flex lg:flex-col lg:justify-between">
      ...
      <div className="relative flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs font-medium text-blue-100/70">{t("auth.tagline")}</p>
        </div>
      </div>
      ...
      <div className="relative max-w-xl">
        ...
        <div className="mt-8 max-w-md rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-sm leading-relaxed text-white/90">{t("auth.quoteText")}</p>
              <p className="mt-2 text-xs font-semibold text-sky-200">{t("auth.quoteAuthor")}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative grid grid-cols-3 gap-3">
        <div className="rounded-2xl border border-white/15 bg-white/10 p-4 backdrop-blur">
          ...
          <p className="mt-1 text-xs text-blue-100/70">{t("auth.stat100")}</p>
        </div>
        <div className="rounded-2xl border border-white/15 bg-white/10 p-4 backdrop-blur">
          <Users className="h-5 w-5 text-sky-300" />
          <p className="mt-3 text-2xl font-extrabold">26 000+</p>
          <p className="mt-1 text-xs text-blue-100/70">{t("auth.statApplicants")}</p>
        </div>
        <div className="rounded-2xl border border-white/15 bg-white/10 p-4 backdrop-blur">
          <ShieldCheck className="h-5 w-5 text-sky-300" />
          <p className="mt-3 text-2xl font-extrabold">7 000+</p>
          <p className="mt-1 text-xs text-blue-100/70">{t("auth.statQuestions")}</p>
        </div>
      </div>
    </div>
  );
